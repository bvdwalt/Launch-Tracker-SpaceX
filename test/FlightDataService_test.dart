  ...
  group('fetchFlightData', () {
    test('returns a flight if the http call completes successfully', () async {
      ...
      when(client.get('https://api.spacexdata.com/v3/launches'))
          .thenAnswer((_) async => http.Response('''[{"flight_number": 1,
      ...
      expect(await FlightDataService.fetchFlightData(client),
    ...
    test('throws an exception if the http call completes with an error', () {
      ...
      expect(FlightDataService.fetchFlightData(client), throwsException);
    });
  });
}
